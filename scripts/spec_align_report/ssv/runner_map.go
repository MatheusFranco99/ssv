...
func RunnerSet() []utils.KeyValue {
	...
	runnerSet.Set("specalea \"github.com/MatheusFranco99/ssv-spec-AleaBFT/alea\"", "\"github.com/MatheusFranco99/ssv-spec-AleaBFT/alea\"")
	...
	runnerSet.Set("\"github.com/MatheusFranco99/ssv/protocol/v2_alea/alea/controller\"\n", "")

	runnerSet.Set("var logger = logging.Logger(\"ssv/protocol/ssv/runner\").Desugar()", "")
	runnerSet.Set("specssv.", "")
	runnerSet.Set("specalea.", "qbft.")
...
func RunnerStateSet() []utils.KeyValue {
	...
	mapSet.Set("\"github.com/MatheusFranco99/ssv/protocol/v2_alea/alea/instance\"", "")
	mapSet.Set("specssv.", "")
...
func SpecRunnerStateSet() []utils.KeyValue {
	...
	mapSet.Set("\"github.com/MatheusFranco99/ssv-spec-AleaBFT/alea\"\n", "")
	return mapSet.Range()
}
...
func AggregatorSet() []utils.KeyValue {
	...
	mapSet.Set("\"github.com/MatheusFranco99/ssv/protocol/v2_alea/alea/controller\"\n", "")
