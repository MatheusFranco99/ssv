...
func initRunnerCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/ssv/runner/runner.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initRunnerStateCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/ssv/runner/runner_state.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initAggregatorCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/ssv/runner/aggregator.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initAttesterCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/ssv/runner/attester.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initProposerCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/ssv/runner/proposer.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initSyncCommitteeCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/ssv/runner/sync_committee.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initSyncCommitteeAggregatorCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/ssv/runner/sync_committee_aggregator.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initRunnerValidationsCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/ssv/runner/runner_validations.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initRunnerSignaturesCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/ssv/runner/runner_signatures.go", c.SSVPath); err != nil {
		panic(err)
	}
