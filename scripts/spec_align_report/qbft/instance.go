...
func initInstanceCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/alea/instance/instance.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initProposalCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/alea/instance/proposal.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initPrepareCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/alea/instance/prepare.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initCommitCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/alea/instance/commit.go", c.SSVPath); err != nil {
		panic(err)
	}
...
func initRoundChangeCompareStruct() *utils.Compare {
	...
	if err := utils.Copy("./protocol/v2_alea/alea/instance/round_change.go", c.SSVPath); err != nil {
		panic(err)
	}
