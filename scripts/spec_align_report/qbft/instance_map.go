...
func InstanceSet() []utils.KeyValue {
	...
	instanceMap.Set("specalea \"github.com/MatheusFranco99/ssv-spec-AleaBFT/alea\"\n", "")
	instanceMap.Set("logging \"github.com/ipfs/go-log\"\n", "")
	instanceMap.Set("\"github.com/MatheusFranco99/ssv/protocol/v2_alea/alea\"\n", "")
	instanceMap.Set("\"go.uber.org/zap\"\n\n", "")
	instanceMap.Set("specalea.", "")
...
func ProposalSet() []utils.KeyValue {
	...
	proposalMap.Set("\"github.com/MatheusFranco99/ssv/protocol/v2_alea/alea\"\n", "")

	proposalMap.Set("qbft.IConfig", "IConfig")
	proposalMap.Set("specalea \"github.com/MatheusFranco99/ssv-spec-AleaBFT/alea\"\n", "")

	proposalMap.Set("specalea.", "")
...
func PrepareSet() []utils.KeyValue {
	...
	prepareMap.Set("specalea \"github.com/MatheusFranco99/ssv-spec-AleaBFT/alea\"\n", "")
	prepareMap.Set("\"go.uber.org/zap\"\n", "")
	prepareMap.Set("\"github.com/MatheusFranco99/ssv/protocol/v2_alea/alea\"\n", "")

	prepareMap.Set("specalea.", "")
...
func CommitSet() []utils.KeyValue {
	...
	commitMap.Set("specalea \"github.com/MatheusFranco99/ssv-spec-AleaBFT/alea\"\n", "")
	commitMap.Set("\"go.uber.org/zap\"\n", "")
	commitMap.Set("\"github.com/MatheusFranco99/ssv/protocol/v2_alea/alea\"\n", "")

	commitMap.Set("specalea.", "")
...
func RoundChangeSet() []utils.KeyValue {
	...
	roundChangeMap.Set("specalea \"github.com/MatheusFranco99/ssv-spec-AleaBFT/alea\"\n", "")
	roundChangeMap.Set("\"go.uber.org/zap\"\n", "")
	roundChangeMap.Set("\"github.com/MatheusFranco99/ssv/protocol/v2_alea/alea\"\n", "")

	roundChangeMap.Set("specalea.", "")
